...
var create_server_1 = __importDefault(require("./utils/create-server"));
var appDir = path_1.resolve(process.cwd(), "build/server.js");
/**
...
var serve = function (_a) {
    var isHttps = _a.isHttps, port = _a.port;
